    ...
    <>
      ...
      >
        ...
        <div className="h-full overflow-y-auto">
          {/* Image container */}
          <div className="relative w-full h-[32vh] xs:h-[40vh] md:h-[60vh] lg:h-[80vh] overflow-hidden rounded-none rounded-b-2xl xl:rounded-t-2xl xl:rounded-r-none group cursor-pointer flex-shrink-0">
            <Image
              src={Data.url}
              alt={Data.title}
              fill
          ...
          <div className="md:p-6 flex gap-5 flex-col justify-center items-center w-full">
            ...
            <div className=' p-6 lg:px-[10%] flex gap-0 flex-col justify-center items-center w-full md:-translate-y-40'>
                {/* Tags */}
                ...
                {/*Title*/}
                <div className='my-7 lg:my-10 justify-center flex flex-col'>
                  <div className={`text-center leading-none font-light text-[3rem] md:text-[5rem] xl:text-[7.5rem]  ${ppplayground.className}`}><span>{Data.title}: </span></div>
                  <span className={`text-center leading-none font-light text-[2rem] md:text-[3rem] xl:text-7xl `}>{Data.description}</span>
                </div>
