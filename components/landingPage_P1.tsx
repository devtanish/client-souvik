  ...
  return (
    <div className="wrapper">
      ...
      <svg ref={svgRef} viewBox="0 0 1560 280" xmlns="http://www.w3.org/2000/svg" className={`w-full ${Lamoric.variable}`}>
        ...
        <rect width="1560" height="280" fill="transparent" />

        <text className="letter" x="125" y="270">
            E
        </text>
        <text className="letter" x="341" y="270">
            X
        </text>
        <text className="letter" x="550" y="270">
            P
        </text>
        <text className="letter" x="740" y="270">
            L
        </text>
        <text className="letter" x="980" y="270">
            O
        </text>
        <text className="letter" x="1215" y="270">
            R
        </text>
        <text className="letter" x="1435" y="270">
            E
        </text>
        </svg>
    </div>
