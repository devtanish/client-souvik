        ...
        <div className="grid gap-1.5 grid-cols-11 grid-rows-5 ">
          ...
          <div className={` col-span-3 row-start-1 row-end-5 mx-10 `}>
            ...
            <div className="mt-6">
              ...
              <div className=" flex underline text-gray-500 text-[15px] font-light"><Image src={"/svg/tick.svg"} height={8} width={20} alt="calendar" className="icon scale-65 mr-2 -translate-y-0.5"/>Lifetime warranty and value guarantee</div>
              <div className=" -translate-x-1 flex underline text-gray-500 text-[15px] font-light"><Image src={"/svg/truck.svg"} height={8} width={30} alt="calendar" className="icon scale-55 mr-0.5 -translate-y-0.5"/>Shipping policy</div>
              <div className=" flex underline -translate-x-1 text-gray-500 text-[15px] font-light"><Image src={"/svg/restart.png"} height={8} width={30} alt="calendar" className="-translate-y-1 icon scale-50 "/>Return policy</div>
            </div>
          </div>
        </div>
      </div>
